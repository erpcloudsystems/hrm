...
class LateComingRequest(Document):
	...
	def on_submit(self):
		...
		if self.get('status') == "Open":
			frappe.throw(_("Only Late Coming Request with status 'Approved' and 'Rejected' can be submitted"))
	...
	def validate_duplicate(self):
		...
		if duplicate:
			frappe.throw(_("Employee has Already Applied for Late Coming Request for this date {}".format(formatdate(self.get('attendance_date')))))
